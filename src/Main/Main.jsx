...
function Main(props){
  let condition = props.subjectSort || props.paramSort;
  useEffect(()=>{
     props.getCards();
  },[]);
  return (
...
function stateToProps(state){
  return {
    ...
    subjectSort: state.forCards.sortVariants.isSubjectSortOn,
    paramSort: state.forCards.sortVariants.isParamSortOn,
    sortedCards: state.forCards.sortVariants.sortedCards,
